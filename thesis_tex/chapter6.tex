...
by a two-decade change in $\ngs$. An earlier draft quoted $2.28\times10^{12}$,
$1.68\times10^{13}$ and $2.48\times10^{14}$ from a record with no producing
script; the stamped scan, the operator at $[15,j]$ with its own CRE $\ngs$
scaled, gives the values in the table, about \SI{1}{\percent} higher.
