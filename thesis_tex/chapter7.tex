...
\emph{[The corollary requires $n_p = A_p + B_p u$ with $A_p$, $B_p$ independent
of $u$. Where that fails, effective Hill coefficients well above unity are
reachable; two Michaelian enzymes competing for a shared substrate is the
standard counterexample. It does not apply here, because $u$ is an external
reservoir rather than a shared pool, but an examiner who knows the
ultrasensitivity literature will reach for it.]}
