...
of the full one. An earlier draft of this appendix said that no script
regenerated them and deferred to a working note; the note's values had the
opposite sign at the benchmark and the cold corner, and the text now records
that. The trap the scan avoids is recorded in Section~\ref{sec:convergence}:
