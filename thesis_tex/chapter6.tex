...
\emph{mechanism} is that the two shells switch supply channels at different
reservoir strengths, and that the switching point moves with the shell pair as
Griem's criterion predicts. That mechanism depends on the \emph{ratio} of the two
shells' responses and on how it scales, not on the absolute normalisation, and
survives either way.
