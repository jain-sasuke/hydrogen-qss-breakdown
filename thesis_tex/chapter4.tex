...
points. An earlier draft quoted $9.4$, $10.7$ and $6.3$ from \texttt{findings\_10} ADDENDUM~D.8 with neither
quantity nor grid point named; the stamped run reproduces them to \SI{0.4}{\percent} as $a_p$ at $[49,0]$. The
absence of a monotone trend over $p=8$ to $10$ that the draft reported holds there and at $47$ of the $280$ points;
...
$10.7$ band, not inside it as ADDENDUM~D.8 states, but within a factor $2.2$ of every value in it, and both rise
...
thin over the region where this thesis makes quantitative claims. An earlier
draft quoted $6.3\times10^{-7}$, $1.0\times10^{-3}$ and $0.263$ from
\texttt{findings\_10} ADDENDUM~D.8, a working note with no producing script;
...
most about \SI{10}{\percent} quoted with them are half-slab figures attached to
a full-slab optical depth. The conclusion is unchanged.
