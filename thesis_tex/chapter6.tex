...
\SIrange{10}{20}{\percent} of $\mathrm{D}\gamma$, the sensitivity at the cold
corner falls from $0.201$ to $0.054$ and at the density maximum from $0.053$ to
$0.019$. Since $\epsplat$ is linear in $\ffrac{3}-\ffrac{4}$, that is a
\textbf{factor of three to five reduction} of the cold-corner plateau error.
...
What is \emph{not} available is a calculation. The factor of three to five
above is arithmetic on two published emissivity fractions, not a solution of a
matrix containing molecular states, and it says how far the cold-corner number
would move under one specific dilution picture rather than what a molecular
model would give. This is the objection most likely to be raised first by a
