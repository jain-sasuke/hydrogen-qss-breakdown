...
estimate of the error exceeds \SI{10}{\percent}, an extremum count over
...
\begin{table}[tbp]
  ...
  which the ELM-averaged estimate of the CR-equilibrium error exceeds
...
for the ELM-averaged estimate at the worst point to fall below the
...
\SI{2}{\electronvolt} whose ELM-averaged estimate exceeds \SI{10}{\percent}
...
the ELM-averaged estimate exceeds \SI{10}{\percent} is \emph{zero} out of
