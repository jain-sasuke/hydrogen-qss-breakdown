...
The bound is built in Section~\ref{sec:molecules} from the emissivity
fractions cited there, not computed from a matrix containing molecules, and it
...
Three calculations would change the standing of a result in this thesis. The
first costs days. The other two are different projects.
