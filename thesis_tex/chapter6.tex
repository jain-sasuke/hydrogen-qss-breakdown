...
cutoff factor varies by about \SI{30}{\percent} across the grid holds for
$n=2$ and fails above $n=9$, where $U_m > 1$ and $F$ falls as $\nel^{-3/2}$;
it is reported here and left in place. What survives is narrower than an
